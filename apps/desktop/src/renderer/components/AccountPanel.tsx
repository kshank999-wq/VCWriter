...
export function AccountPanel({
    ...
    return (
      <>
        <div className="account">
          ...
          <p className="muted">
            VC Writer works fully without it — your projects are files on this
            computer. Sync and VC Writer Notes need the Supabase keys to be
            present when the app is built.
          </p>
        </div>
        <ReportingPanel />
      </>
    ...
    return (
      <>
        <div className="account">
          ...
          <p className="muted">
            Notes captured on your phone appear here for review. Nothing is
            added to a project until you approve it.
          </p>
  ...
  const verify = async () => {
    setBusy(true);
    setError(null);
    const result = await window.vcwriter.verifySignInCode({
      email: email.trim(),
      code: code.trim(),
    });
    setBusy(false);
  ...
  return (
    <>
      <div className="account">
        ...
        <p className="muted">
          Optional. Signing in syncs this project and brings in notes captured
          on your phone. Your projects stay files on this computer either way.
        </p>
