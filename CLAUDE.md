...
- `docs/spec/` — the master spec and `addendum-02-workspace.md`, which
  ...
  Editors page: stages 1–5 (the global layer, the five commandments, the
  grid itself, the AI read answering the five, and the value graph) are
  built — §9 says what they do — and §8 lists what is left: printing it.
